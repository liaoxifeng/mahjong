...
-export_type(['C2S_Login'/0, 'S2C_Login'/0, 'S2C_Err'/0, 'S2C_PlayerInfo'/0, 'C2S_Heartbeat'/0, 'S2C_Heartbeat'/0, 'C2S_Gm'/0, 'S2C_Gm'/0]).

-spec encode_msg(#'C2S_Login'{} | #'S2C_Login'{} | #'S2C_Err'{} | #'S2C_PlayerInfo'{} | #'C2S_Heartbeat'{} | #'S2C_Heartbeat'{} | #'C2S_Gm'{} | #'S2C_Gm'{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#'C2S_Login'{} | #'S2C_Login'{} | #'S2C_Err'{} | #'S2C_PlayerInfo'{} | #'C2S_Heartbeat'{} | #'S2C_Heartbeat'{} | #'C2S_Gm'{} | #'S2C_Gm'{}, atom() | list()) -> binary().
